...
dependencyManagement {
     imports {
          mavenBom "io.projectreactor:reactor-bom:Bismuth-SR16"
     }
}
```
...
You should then be able to import a `BUILD-SNAPSHOT` version of the BOM, like `Bismuth.BUILD-SNAPSHOT`.

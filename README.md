...
<dependencyManagement>
    <dependencies>
        <dependency>
            ...
            <version>Californium-SR7</version>
            <type>pom</type>
            <scope>import</scope>
        </dependency>
    </dependencies>
...
dependencies {
     // import BOM
     implementation platform('io.projectreactor:reactor-bom:Californium-SR7')
...
dependencyManagement {
     imports {
          mavenBom "io.projectreactor:reactor-bom:Californium-SR7"
     }
}
```

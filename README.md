...
You should then be able to import a `-SNAPSHOT` version of the BOM, like `2020.0.4-SNAPSHOT` for the `snapshot` of the `second service release` of `2020.0` (Europium).

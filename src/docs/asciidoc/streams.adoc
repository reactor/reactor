...
.Chunk processing with Stream buffer:
[cols="2,6", options="header"]
|===
|Functional API
|Role
...
|buffer(Publisher<?> bucketOpening, Supplier<? extends Publisher<?>>)
|

|buffer(Supplier<? extends Publisher<?>> boundarySupplier)
|

|buffer(int maxSize, int skip)
|

|buffer(long timespan, long timeshift, TimeUnit unit, Timer time)
|
...
.Chunk processing with Stream window:
[cols="2,6", options="header"]
|===
|Functional API
|Role
...
|window(Publisher<?> bucketOpening, Supplier<? extends Publisher<?>>)
|

|window(Supplier<? extends Publisher<?>> boundarySupplier)
|

|window(int maxSize, int skip)
|

|window(long timespan, long timeshift, TimeUnit unit, Timer time)
|

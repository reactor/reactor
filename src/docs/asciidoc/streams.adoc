...
2+a| image::images/marble/marble-overflowbuffer.png[onOverflowBuffer(), width=500, align="center", link="images/marble/marble-overflowbuffer.png"]
...
2+a| image::images/marble/marble-overflowdrop.png[onOverflowDrop(), width=500, align="center", link="images/marble/marble-overflowdrop.png"]

|throttle(*long*)
|Delay downstream `request(long)` and periodically decrement the accumulated demand one by one to request upstream.
2+a| image::images/marble/marble-throttle.png[throttle(delay), width=500, align="center", link="images/marble/marble-throttle.png"]
...
2+a| image::images/marble/marble-requestwhen.png[requestWhen(requestMapper), width=500, align="center", link="images/marble/marble-requestwhen.png"]
...
|zip(_arguments_), zipWith(_arguments_)

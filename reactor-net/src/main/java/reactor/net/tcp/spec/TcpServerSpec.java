...
public class TcpServerSpec<IN, OUT> extends EventRoutingComponentSpec<TcpServerSpec<IN, OUT>, TcpServer<IN, OUT>> {
	...
	private Collection<Consumer<NetChannel<IN, OUT>>> connectionConsumers;
	 ...
	 * @return {@literal this}
	 */
	public TcpServerSpec<IN, OUT> consume(@Nonnull Consumer<NetChannel<IN, OUT>> connectionConsumer) {
	 ...
	 * @return {@literal this}
	 */
	public TcpServerSpec<IN, OUT> consume(@Nonnull Collection<Consumer<NetChannel<IN, OUT>>> connectionConsumers) {

 ...
 * A {@link reactor.io.net.ReactivePeer} which accepts a callback on start to receive connections or
 * {@link reactor.io.net.ReactiveChannel} that expose input() {@link org.reactivestreams.Publisher} of input data.

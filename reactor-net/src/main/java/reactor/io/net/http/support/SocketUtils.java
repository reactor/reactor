 ...
 */
package reactor.io.net.http.support;
 ...
 *
 * <p>Within this class, a TCP port refers to a port for a {@link java.net.ServerSocket};
 * whereas, a UDP port refers to a port for a {@link java.net.DatagramSocket}.</p>
 *
 * @author Sam Brannen
 * @author Ben Hale

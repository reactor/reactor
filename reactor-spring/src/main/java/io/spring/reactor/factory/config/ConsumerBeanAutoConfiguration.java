package io.spring.reactor.factory.config;

import io.spring.reactor.annotation.ReplyTo;
import io.spring.reactor.annotation.Selector;
 ...
 * {@link org.springframework.context.ApplicationContext} that look like a {@link io.spring.reactor.annotation.Consumer}

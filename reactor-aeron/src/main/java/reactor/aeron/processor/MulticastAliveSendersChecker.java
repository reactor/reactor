...
/**
 *
 * Checks if there is any alive Aeron signals senders in a multicast communication between instances of
 * {@link AeronSubscriber} and {@link AeronPublisher}
 *
 * @author Anatoly Kadyshev
 */
class MulticastAliveSendersChecker implements AliveSendersChecker {
	...
	MulticastAliveSendersChecker(Logger logger, Context context, AeronHelper aeronHelper, Publication commandsPub) {
		this.logger = logger;

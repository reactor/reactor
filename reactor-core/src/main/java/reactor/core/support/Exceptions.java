...
public final class Exceptions {
	 ...
	 * If the final cause wasn't of type {@link reactor.core.support.Exceptions.ValueCause},
	 * return null;
	 *
	 * @param e
	...
	public static class ValueCause extends RuntimeException {
		...
		/**
		 * Create a {@code CauseValue} exception and include in its error message a string representation of
		 * the item that was intended to be emitted at the time the exception was handled.
		 *
		 * @param value
		 *         the item that the component was trying to emit at the time of the exception
		 */
		 ...
		 *
		 * @return the item that the component was trying to emit at the time of the exception
		 */

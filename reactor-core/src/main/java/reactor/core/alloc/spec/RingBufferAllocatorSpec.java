 ...
 * reactor.fn.Supplier} and {@link Consumer}.
 *
 * @author Jon Brisbin
 * @since 1.1
 */
public class RingBufferAllocatorSpec<T extends Recyclable> implements Supplier<RingBufferAllocator<T>> {
	...
	/**
	 * The {@link reactor.fn.Supplier} to provide the {@code RingBuffer} with the reusable objects that are being
	 * pooled.
	 *
	 * @param allocator
	 *
	...
	/**
	 * The {@link reactor.fn.Consumer} to be invoked with a sequence ID is published.
	 *
	 * @param eventHandler
	 *
	 * @return {@code this}
	...
	/**
	 * The {@link reactor.fn.Consumer} to be invoked when an error occurs.
	 *
	 * @param errorHandler
	 *
	 * @return {@code this}

...
public abstract class Factories {
	...
	/**
	 * Create a {@link BatchFactorySupplier} that supplies instances of the given type, which
	 ...
	 *
	 * @return a {@link BatchFactorySupplier} to supply instances of {@literal type}.
	 */

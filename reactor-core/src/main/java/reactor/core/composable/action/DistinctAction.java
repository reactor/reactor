 ...
 * @since 1.1
 */
public class DistinctAction<T> extends Action<T,T> {

	private T lastData;

	public DistinctAction(Dispatcher dispatcher, ActionProcessor<T> actionProcessor) {

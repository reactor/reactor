...
import reactor.event.selector.Taggable;

import java.util.Set;

/**
 * Matches a {@link reactor.event.selector.Selector} and key like normal, but only if the key is
 * {@link reactor.event.selector.Taggable} and the key and selector have at least one tag in
 * common.
 *
 * @author Jon Brisbin

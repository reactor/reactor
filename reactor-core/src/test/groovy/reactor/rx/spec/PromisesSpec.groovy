...
class PromisesSpec extends Specification {
  ...
  def "An IllegalStateException is thrown if an attempt is made to fulfil a fulfilled promise"() {
    given:
      "a fulfilled promise"
      def promise = Promises.<Integer>config().synchronousDispatcher().get()
	...
	def "An IllegalStateException is thrown if an attempt is made to reject a rejected promise"() {
		given:
			"a rejected promise"
			Promise promise = Promises.config().synchronousDispatcher().get()
  ...
  def "An IllegalStateException is thrown if an attempt is made to reject a fulfilled promise"() {
    given:
      "a fulfilled promise"
      def promise = Promises.config().synchronousDispatcher().get()
  ...
  def "Multiple promises can be combined"() {
    given:
      ...
      def promise1 = Promises.<Integer>config().synchronousDispatcher().get()
	    def promise2 = Promises.<Integer>config().synchronousDispatcher().get()

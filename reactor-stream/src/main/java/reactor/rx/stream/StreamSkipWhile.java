...
/**
 * Skips source values while a predicate returns true for the value.
 *
...
public final class StreamSkipWhile<T> extends StreamBarrier<T, T> {
	...
	static final class StreamSkipWhileSubscriber<T>
			implements Subscriber<T>, Downstream, ActiveUpstream, FeedbackLoop, Upstream {

...
/**
 * Delays the subscription to the main source until another Publisher signals a value or completes.
 *
 ...
 * @since 2.5
 */
public final class StreamDelaySubscription<T, U> extends StreamBarrier<T, T> {

	final Publisher<U> other;

	public StreamDelaySubscription(Publisher<? extends T> source, Publisher<U> other) {
		super(source);
	...
	static final class StreamDelaySubscriptionOtherSubscriber<T, U> extends SubscriberDeferSubscription<U, T> {

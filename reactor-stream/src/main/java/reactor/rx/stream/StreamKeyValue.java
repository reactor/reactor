 ...
 * specified.
 * <p>
 * The TimerStream will manage dedicated timers for new subscriber assigned via
 ...
 */
public final class StreamKeyValue extends Stream<Long> {
	...
	public StreamKeyValue(long delay, long period, TimeUnit unit, Timer timer) {

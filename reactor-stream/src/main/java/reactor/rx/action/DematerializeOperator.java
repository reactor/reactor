 ...
 * @since 2.0, 2.1
 */
public final class DematerializeOperator<T> implements Publishers.Operator<Signal<T>, T> {

	public static final DematerializeOperator INSTANCE = new DematerializeOperator();

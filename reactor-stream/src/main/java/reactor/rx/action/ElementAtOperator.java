 ...
 * @since 2.0, 2.1
 */
public final class ElementAtOperator<T> implements Publishers.Operator<T, T> {

	private final int     index;
	private final T       defaultValue;
	private final boolean defaultProvided;

	public ElementAtOperator(int index) {
		this(index, null, false);
	}

	public ElementAtOperator(int index, T defaultValue) {
		this(index, defaultValue, true);
	}

	public ElementAtOperator(int index, T defaultValue, boolean defaultProvided) {
		if (index < 0) {

 ...
 * @since 2.0, 2.1
 */
public final class BufferShiftOperator<T> implements Publishers.Operator<T, List<T>> {
	...
	public BufferShiftOperator(int size, int skip) {
		this(size, skip, -1L, -1L, null, null);
	}

	public BufferShiftOperator(int size,
			int skip,

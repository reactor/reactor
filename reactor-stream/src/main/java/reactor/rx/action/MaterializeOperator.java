 ...
 * @since 2.0, 2.1
 */
public final class MaterializeOperator<T> implements Publishers.Operator<T, Signal<T>> {

	public static final MaterializeOperator INSTANCE = new MaterializeOperator();

	@Override
	public Subscriber<? super T> apply(Subscriber<? super Signal<T>> subscriber) {
		return new MaterializeAction<>(subscriber);
	}

...
|reactor.core.publisher.\*, reactor.rx.*, reactor.rx.action.\*, reactor.io.net.*
...
|Operator
|Function<Subscriber<? super OUT>, Subscriber<? super IN>>
|Decorate/Lift given output and providing input Reactive Streams Subscribers
